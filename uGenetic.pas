...
begin
  ...
  Result := (12* (rowSumAll + colSumAll) +  33 * (rowMissed + colMissed)) / 100+(rowProdAll  + colProdAll) / 1000;
  FitnessValue := Result;
end;
...
//
//  CROSSINGOVER Chromosome + Chromosome
//
...
begin
  ...
  case curNum of
    ...
    2:  begin
          ...
          for iGene := 1 to 9 do
          begin
           if (IndStart <> iGene) and (IndEnd2 <> iGene) and (not isFixed(sqNum, iGene)) then
           begin
             IndEnd2 := iGene;
           end;
          end;
